...
// clients to drop their old runtime caches. Bumped to v6: revert to
// BrowserRouter with basename=/portami/ and ship a 404.html fallback
// (a copy of index.html generated by Vite) so GitHub Pages serves the
// SPA for any unknown path — clean URLs without # and no 404 on refresh.
